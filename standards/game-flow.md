# Game flow
## Title screen
After booting the game, the player will enter the title screen. It should be transparent with only the game's logo showing and a button that moves them to the next section.
